...
plink -batch sol@%bm_rpc1% "tail -n500 logs/solana-validator.log | grep -m 1 \"new root\"" ^
&& plink -batch sol@%bm_rpc2% "tail -n500 logs/solana-validator.log | grep -m 1 \"new root\""
if %ERRORLEVEL% NEQ 0 (
